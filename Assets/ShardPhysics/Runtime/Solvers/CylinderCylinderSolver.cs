...
namespace Shard.Runtime.Solvers
{
    public static class CylinderCylinderSolver
    {
        ...
        public static bool Solve(in Cylinder a, in Cylinder b, out ContactPointManifold cc)
        {
            cc = default;
    ...
    ref ContactPointManifold cc)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void EmitOne(ref ContactPointManifold cc, float3 p, float3 nAB, float depth)
        {
            cc = default;
            InvalidateAll(ref cc);
    ...
    ref ContactPointManifold cc)
        ...
        private static bool EmitParallelSidePoint(
            ...
            ref ContactPointManifold cc, ref int count)
        {
            // A axis point
    ...
    ref ContactPointManifold cc)
        ...
        private static void DedupAndCompact(ref ContactPointManifold cc)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void Write(ref ContactPointManifold cc, int index, ContactPoint cp)
        {
            if (index == 0) cc.p1 = cp;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void InvalidateAll(ref ContactPointManifold cc)
        {
            cc.p1.depth = -1f;
            cc.p2.depth = -1f;
            cc.p3.depth = -1f;
