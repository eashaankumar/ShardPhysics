    ...
    namespace Shard
    {
        internal static class BoxBoxManifold
        {
                                        ...
                                        ref ContactManifold m)
            {
                ...
                AxisChoice best = default;
                best.MinPen = float.PositiveInfinity;
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    Consider(ref best, pen, axisW, AxisKind.FaceA, i, 0, sign, tW);
                }
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    Consider(ref best, pen, axisW, AxisKind.FaceB, i, 0, sign, tW);
                }
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    for (int j = 0; j < 3; j++)
                    {
                        ...
                        Consider(ref best, pen, axisW, AxisKind.EdgeEdge, i, j, sign, tW);
                    }
                }
                ...
                float3 refN = n; // use the manifold normal as the reference normal
                float3 refFaceCenter = refC + refN * refE[refAxis];
                ...
                for (int i = 0; i < poly.Count; i++)
                {
                    ...
                    AddPoint(ref m, cp, depth, fidBase + (uint)i);
                }
